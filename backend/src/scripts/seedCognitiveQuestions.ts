...
const VR_PASSAGE =
  "India is a land of festivals. Every month brings some festival or the other. Diwali, the festival of lights, is one of the most popular. People clean their homes, decorate with lights and burst crackers. Sweets are distributed, and families get together to celebrate.";

const cognitiveQuestions = [
  // ═══════════════════════════════════════════════════
  // PART 1: VERBAL REASONING (Q1-20)
  // ═══════════════════════════════════════════════════

  // Parameter A: Analogies (Q1–7)
  ...
  // Parameter B: Language Comprehension (Q8–13) — with passage
  q(1, "Verbal Reasoning", 8, "What is Diwali known as?", ["Festival of crackers", "Festival of sweets", "Festival of lights", "Festival of India"], "C", VR_PASSAGE),
  q(1, "Verbal Reasoning", 9, "What do people do during Diwali?", ["Go to beaches", "Watch movies", "Decorate homes and burst crackers", "Visit hospitals"], "C", VR_PASSAGE),
  q(1, "Verbal Reasoning", 10, "How often do festivals occur in India?", ["Only in December", "Every month", "Only in summer", "Once a year"], "B", VR_PASSAGE),
  q(1, "Verbal Reasoning", 11, "What is one activity people do NOT do during Diwali?", ["Eat sweets", "Decorate homes", "Fly kites", "Burst crackers"], "C", VR_PASSAGE),
  q(1, "Verbal Reasoning", 12, "Why do families get together during Diwali?", ["To attend meetings", "To prepare for exams", "To celebrate", "To clean streets"], "C", VR_PASSAGE),
  q(1, "Verbal Reasoning", 13, "What is the main idea of the passage?", ["Diwali is a boring festival", "India has no festivals", "India has many festivals and Diwali is popular", "Sweets are unhealthy"], "C", VR_PASSAGE),

  // Parameter C: Sentence Completion (Q14–17)
  ...
  // Parameter D: Logical Verbal Reasoning (Q18–20)
  ...
  // ═══════════════════════════════════════════════════
  // PART 2: NUMERICAL REASONING (Q1-20)
  // ═══════════════════════════════════════════════════

  // Parameter A: Arithmetic & Number Sense (Q1–6)
  ...
  // Parameter B: Patterns & Sequences (Q7–11)
  ...
  // Parameter C: Geometry & Measurement (Q12–15)
  ...
  // Parameter D: Data Interpretation & Word Problems (Q16–20)
  ...
  // ═══════════════════════════════════════════════════
  // PART 3: SPATIAL REASONING (Q1-20)
  // ═══════════════════════════════════════════════════

  // Parameter A: Pattern Recognition (Q1–5)
  ...
  // Parameter B: Mental Rotation (Q6–10)
  ...
  // Parameter C: Mirror & Water Images (Q11–14)
  q(3, "Spatial Reasoning", 11, 'Mirror image of "CAT" is:', ["TAC", "Ɉ∀Ɔ", "⅁∀Ɔ", "C∀T"], "C"),
  q(3, "Spatial Reasoning", 12, 'Water image of the number "203" is:', ["302", "203", "ʍƐO", "ƐOƧ"], "D"),
  ...
  // Parameter D: Paper Folding & Cutting (Q15–17)
  ...
  q(3, "Spatial Reasoning", 16, "A paper is folded and punched once in the middle. When opened, how many holes will be there?", ["1", "2", "3", "Depends on the folds"], "B"),
  q(3, "Spatial Reasoning", 17, "A square is folded diagonally and cut on the folded edge. When unfolded, it forms:", ["Square", "Triangle", "Kite", "Rhombus"], "C"),

  // Parameter E: Spatial Visualization (Q18–20)
  ...
  // ═══════════════════════════════════════════════════
  // PART 4: MEMORY AND PROCESSING SPEED (Q1-20)
  // ═══════════════════════════════════════════════════

  // Parameter A: Visual Memory & Recall (Q1–6)
  ...
  // Parameter B: Processing Speed (Q7–11)
  ...
  q(4, "Memory & Processing Speed", 10, "Which of the following has the highest value?", ["½", "0.45", "0.49", "0.5"], "D"),
  q(4, "Memory & Processing Speed", 11, "Which is not a multiple of 3?", ["27", "33", "32", "30"], "C"),

  // Parameter C: Symbol & Letter Matching (Q12–15)
  q(4, "Memory & Processing Speed", 12, 'If "@" = A, "#" = B, and "$" = C, then what does "@$#" represent?', ["ABC", "ACB", "CAB", "BAC"], "D"),
  q(4, "Memory & Processing Speed", 13, "If A = 1, B = 2, ..., then what is the sum of D + G?", ["9", "11", "10", "7"], "A"),
  ...
  // Parameter D: Attention & Matching Speed (Q16–20)
  ...
  q(4, "Memory & Processing Speed", 20, "Which number is missing: 9, __, 25, 36", ["16", "18", "20", "22"], "A"),
];
...
async function seed() {
  try {
    ...
    console.log("Cleared existing cognitive questions");

    await Question.insertMany(cognitiveQuestions);
    console.log(
      `✅ Inserted ${cognitiveQuestions.length} cognitive questions (4 parts × 20 Qs)`
    );

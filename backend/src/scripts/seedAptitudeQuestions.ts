...
const aptitudeQuestions = [
  ...
  q(1, "Logical & Analytical Reasoning", 4, "Which number comes next? 21, 18, 15, 12, ?", ["10", "9", "6", "3"], "B"),
  ...
  q(1, "Logical & Analytical Reasoning", 9, "If SUN = 54, MOON = 57, then STAR = ?", ["58", "56", "60", "61"], "A"),
  ...
  q(1, "Logical & Analytical Reasoning", 14, "Three children – A, B, and C – are playing. A is not the oldest. C is not the youngest. Who is the oldest?", ["A", "B", "C", "Can't say"], "D"),
  ...
  q(1, "Logical & Analytical Reasoning", 16, "Which item fits into both \"Stationery\" and \"Sharp Objects\"?", ["Book", "Knife", "Scissors", "Rubber"], "C"),
  ...
  q(1, "Logical & Analytical Reasoning", 19, "If today is Wednesday, what will be the day 15 days from now?", ["Thursday", "Friday", "Saturday", "Thursday"], "D"),
  q(1, "Logical & Analytical Reasoning", 20, "Five birds are sitting on a wire. A hunter shoots one. How many are left?", ["4", "0", "5", "1"], "B"),
  q(2, "Numerical Aptitude", 1, "What is the value of: 28 ÷ 4 + 5 × 2", ["2", "17", "18", "24"], "B"),
  q(2, "Numerical Aptitude", 2, "What is 25% of 320?", ["64", "72", "80", "85"], "C"),
  q(2, "Numerical Aptitude", 3, "Find the HCF of 36 and 60:", ["6", "12", "24", "18"], "B"),
  q(2, "Numerical Aptitude", 4, "A shopkeeper sells an item for ₹600 and makes a profit of 20%. What was the cost price?", ["₹480", "₹500", "₹520", "₹550"], "B"),
  q(2, "Numerical Aptitude", 5, "A car covers 72 km in 2 hours. What is its speed?", ["10 m/s", "18 m/s", "20 m/s", "12 m/s"], "A"),
  q(2, "Numerical Aptitude", 6, "What is the ratio of 50 paise to ₹5?", ["1:5", "1:10", "1:15", "1:20"], "B"),
  q(2, "Numerical Aptitude", 7, "Simplify: 3/4 + 2/3", ["13/12", "12/13", "17/12", "5/7"], "C"),
  ...
  q(3, "Verbal Aptitude", 7, "What is the Himalayas' rank in terms of age and height?", ["Oldest and highest", "Youngest and lowest", "Youngest and highest", "Average"], "C"),
  q(3, "Verbal Aptitude", 8, "The Himalayas separate:", ["India and Africa", "Asia and Africa", "India and Europe", "India and the rest of Asia"], "D"),
  q(3, "Verbal Aptitude", 9, "What is found in the Himalayas?", ["Deserts", "Plains", "Rivers and glaciers", "Volcanoes"], "C"),
  q(3, "Verbal Aptitude", 10, "Which of these is not mentioned in the passage?", ["Rivers", "Glaciers", "Animals", "Mountains"], "C"),
  q(3, "Verbal Aptitude", 11, "Which word in the passage means natural wall?", ["Glacier", "Subcontinent", "Barrier", "Mountain"], "C"),

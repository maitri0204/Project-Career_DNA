      ...
      <section className="relative pt-28 pb-24 px-6 bg-gradient-to-b from-[#d0e5f5] to-[#e8f3fa] overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer}>
            ...
            >
              A comprehensive <span className="font-bold text-[#0e5080]">Career DNA Profiler</span> designed to evaluate and improve mathematical thinking and numeric reasoning skills.
            </motion.p>
      ...
      <footer className="py-12 px-6 bg-slate-900 text-slate-400">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-3">
            ...
            <span className="text-white font-bold text-lg">Career DNA Profiler</span>
          </div>

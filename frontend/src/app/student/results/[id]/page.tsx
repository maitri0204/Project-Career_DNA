    ...
    try {
      ...
      await generateCareerDnaCapabilityReport({
        ...
        otherSectionScores: {
          ...
          PERSONALITY: {
            score: breakdowns.PERSONALITY?.totalScore || 0,
            maxScore: breakdowns.PERSONALITY?.maxScore || 100,
            parts: breakdowns.PERSONALITY?.parts || [],
            personalityType: breakdowns.PERSONALITY?.personalityType || "",
            personalityDimensions: breakdowns.PERSONALITY?.personalityDimensions || [],
          },
          CAREER_INTEREST: {
            score: breakdowns.CAREER_INTEREST?.totalScore || 0,
            maxScore: breakdowns.CAREER_INTEREST?.maxScore || 100,
            parts: breakdowns.CAREER_INTEREST?.parts || [],
            dominantCode: breakdowns.CAREER_INTEREST?.dominantCode || "",
          },
          ...
          LEARNING_STYLE: {
            score: breakdowns.LEARNING_STYLE?.totalScore || 0,
            maxScore: breakdowns.LEARNING_STYLE?.maxScore || 100,
            parts: breakdowns.LEARNING_STYLE?.parts || [],
            dominantCode: breakdowns.LEARNING_STYLE?.dominantCode || "",
          },
